...
const CheckOutPage = () => {
    ...
    const { data, isLoading } = useQuery(['order', paymentID], () => axios.get(`https://safe-plains-03194.herokuapp.com/order/${paymentID}`))
    ...
    useEffect(() => {
        axios.post(`https://safe-plains-03194.herokuapp.com/create-payment-intent`, { price }).then(response => setClientSecret(response.data.clientSecret))
    }, [price]);
    if (isLoading) {
        ...
        stripe.confirmCardPayment(clientSecret, {
            ...
            .then(function (result) {
                ...
                if (result.paymentIntent) {
                    ...
                    axios.post('https://safe-plains-03194.herokuapp.com/payment', {
                        paymentId: paymentId,
                        price: price,
                    ...
                    axios.put(`https://safe-plains-03194.herokuapp.com/order/${paymentID}`, { payment: true, paymentId: result.paymentIntent.id })
                }
