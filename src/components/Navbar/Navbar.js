            ...
            <div class="navbar-start">
                <div class="dropdown">
                    ...
                    <ul tabindex="0" class="menu menu-compact dropdown-content mt-3 p-2 shadow bg-accent rounded-box w-52">
                        ...
                        {
                            user ? <li><button onClick={logOut} className='btn   btn-color' >Sign Out</button></li> : <li><Link to='login'>Login</Link></li>
                        }
                    </ul>

                </div>
                <Link to='/' class="btn btn-ghost normal-case text-xl">NStock</Link>
