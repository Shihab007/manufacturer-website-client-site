...
const GetInTouch = () => {
    return (
        // <div className='container mx-auto' style={{ background: `linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)),url(${"https://i.ibb.co/hYV4wMk/istockphoto-1212230930-170667a.jpg"})`, backgroundRepeat: 'no-repeat', backgroundSize: 'cover' }}>
