...
const DeleteConfirmModal = ({ product, refetch, ordersForModal, orderDeleteRefetch }) => {
    const handleDeleteProduct = async (id) => {
        await axios.delete(`https://safe-plains-03194.herokuapp.com/part/${id}`)
        refetch()
        toast.success('Item deleted')
    }
    const handleDeleteOrder = async (id) => {
        await axios.delete(`https://safe-plains-03194.herokuapp.com/order/${id}`)
        orderDeleteRefetch()
        toast.success('Item deleted')
    }
            ...
            <div class="modal modal-bottom sm:modal-middle">
                <div class="modal-box">
                    ...
                    <div class="modal-action">
                        ...
                        <label onClick={() => handleDeleteProduct(product._id)} for="delete-confirm-modal" class="btn btn-color">Delete</label>
                    </div>
                </div>
            </div>
            ...
            <div class="modal modal-bottom sm:modal-middle">
                <div class="modal-box">
                    ...
                    <div class="modal-action">
                        ...
                        <label onClick={() => handleDeleteOrder(ordersForModal._id)} for="delete-confirm-modal-orders" class="btn btn-color">Delete</label>
                    </div>
                </div>
            </div>
        </div>
