...
const PurchaseSinglePage = () => {
    ...
    const { id } = useParams()
    const { data: product, isLoading, refetch } = useQuery(('parts', id), () => axios.get(`https://safe-plains-03194.herokuapp.com/parts/${id}`))
    ...
    const hanldeSubmit = e => {
        ...
        axios.post('https://safe-plains-03194.herokuapp.com/order', order).then(response => {
        ...
        axios.put(`https://safe-plains-03194.herokuapp.com/parts/${id}`, doc).then(response => {
